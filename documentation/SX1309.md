Modified from original StyleCop rule documentation, at 2026-06-09
...
This rule only checks the name of private instance fields. It ignores fields that are `static`, `const`, or have public, or
internal accessibility. In C# 8 and later, `readonly` instance members on structs (e.g. `readonly` methods
